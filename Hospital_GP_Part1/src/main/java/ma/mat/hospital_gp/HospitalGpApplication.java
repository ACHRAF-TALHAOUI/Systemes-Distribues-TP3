...
/*
        patientRepository.save(new Patient(null,"Ali",new Date(),false,84));
        patientRepository.save(new Patient(null,"Saad",new Date(),false,97));
        patientRepository.save(new Patient(null,"Yassine",new Date(),true,80));
